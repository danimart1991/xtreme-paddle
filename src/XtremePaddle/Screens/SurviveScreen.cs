...
{
    /// <summary>
    /// Esta pantalla implementa la logica actual para supervivencia.
    /// Contiene todo el gameplay incorporando varias clases.
    /// </summary>
    class SurviveScreen : GameScreen
    {
        #region Variables
        ...
        static int puntMaxSuperv = GameStateManagementGame.Settings.PuntMaxSuperv;
        ...
        public override void LoadContent()
        {
            ...
            Song song = content.Load<Song>("songs/J1_0");
            ...
            posScoreJ1 = new Vector2(posTopLeft.X + 10, posTopLeft.Y + 10);
                                                       ...
                                                       bool coveredByOtherScreen)
        {
            ...
            if (IsActive)
            {
                ...
                // Si somos paleta IA vamos por la ball, a no ser que estemos congelados. 
                ...
                if (fueraBola == 1)
                {   // Si marca la IA se acaba el juego
                    ...
                    ScreenManager.AddScreen(new SurviveEndMenuScreen(scoreJ1));
                }
                else if (fueraBola == -1)
                {   // Si marca el J1
                ...
                // Hacemos funcionar los PowerUps
                if (tempoPower > 0)
                {
