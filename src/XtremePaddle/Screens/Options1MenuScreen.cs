...
namespace XtremePaddle
{
    ...
    /// </summary>
    class Options1MenuScreen : MenuScreen
    {
        #region Variables
        ...
        MenuEntryObject difSuperMenuObject;
        ...
        /// Constructor.
        /// </summary>
        public Options1MenuScreen()
            : base(CatStrings.options1Tittle)
        {
            ...
            difSuperMenuObject = new MenuEntryObject("screens/options/difSuperv", new Vector2(310, 120));
            ...
            MenuEntryText paddleJ2MenuEntry = new MenuEntryText(CatStrings.iaOptions, new Vector2(415, 200), "aboutfont", false);
            MenuEntryText paddleJ2MenuEntryShadow = new MenuEntryText(CatStrings.iaOptions, new Vector2(417, 203), Color.Black, "aboutfont", false);
            ...
            difSuperMenuObject.Selected += DiffSuperSelected;
            ...
            MenuEntriesObject.Add(difSuperMenuObject);
        ...
        /// <summary>
        /// Evento que surge al seleccionar el boton diffSuper.
        /// </summary>
        void DiffSuperSelected(object sender, EventArgs e)
        {
            difficult = 0;
            offXtreme.Color = Color.Gray;
            currentDifficult.Position = new Vector2((difSuperMenuObject.Position.X + (difSuperMenuObject.Rectangle.Width / 2)) - 14, 175);
        ...
        {
            if ((xtremeBool != false) && (difficult != 0))
            {
                xtremeBool = false;
        ...
        {
            if (difficult != 0)
                LoadingScreen.Load(ScreenManager, true, new UnPlayerScreen(difficult));
            else
